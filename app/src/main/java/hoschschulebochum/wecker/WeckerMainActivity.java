...
public class WeckerMainActivity extends AppCompatActivity {
    ...
    public void onToggleClicked(View view) {
        if (((ToggleButton) view).isChecked()) {
            ...
            Intent myIntent = new Intent(WeckerMainActivity.this, AlarmReceiver.class);
            pendingIntent = PendingIntent.getBroadcast(WeckerMainActivity.this, 0, myIntent, 0);
    ...
    public static WeckerMainActivity instance() {
        return inst;
    }
